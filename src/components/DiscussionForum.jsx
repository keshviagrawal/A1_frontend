    ...
    const renderMessage = (msg, isReply = false) => {
        ...
        return (
            <div key={msg._id} className="forum-message" style={{
                ...
                borderLeft: isReply ? "3px solid var(--gray-200)" : msg.isAnnouncement ? "3px solid var(--danger)" : msg.isPinned ? "3px solid var(--warning)" : "1px solid var(--border)",
                background: msg.isAnnouncement ? "#fff5f5" : msg.isPinned ? "#fffef0" : "var(--white)",
            }}>
